...
var _ = Describe("Parameterized Backup and Restore Chart Installation Tests", func() {
	var _ = DescribeTable("Test: Backup and Restore Chart Installation with multiple storage",
		...
		charts.QaseEntry("[QASE-8271,8272] Install and Uninstall Backup Restore Chart with S3 Storage",
		...
		charts.QaseEntry("[QASE-8271,8272] Install and Uninstall Backup Restore Chart with Local Storage Class",
